...
const Chat = () => {
        ...
        prev.map((msg) =>
          msg.id === thinkingId
            ? {
                ...msg,
                content:
                  "Sorry, Nyaya AI is currently unavailable. Please try again.",
              }
            : msg
        )
      );
  ...
  const suggestedQueries = [
    ...
    },
    {
      ...
      label: "Property",
      query:
        "How does property inheritance work under Hindu Succession Act?",
    },
    {
      icon: BookOpen,
      label: "Business",
      query:
        "What are the compliance requirements for starting a company in India?",
    },
  ];
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-6">
              {suggestedQueries.map((item, index) => (
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm bg-card border rounded-lg hover:bg-secondary"
                >
                  <item.icon className="w-4 h-4" />
                  {item.label}
                </button>
                  ...
                  >
                    {message.type === "assistant" && (
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium">Nyaya AI</span>
                      </div>
                    )}
